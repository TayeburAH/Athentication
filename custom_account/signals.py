...
def delete_folder(sender, instance, *args, **kwargs):
    try:
        cloudinary.api.delete_resources_by_prefix(f"media/profile_images/{instance.pk}")
        print('Deleted all image')
        cloudinary.api.delete_folder(f"media/profile_images/{instance.pk}")  # Folder not empty
